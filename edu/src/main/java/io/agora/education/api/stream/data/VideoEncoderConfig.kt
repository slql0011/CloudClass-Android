...
data class VideoEncoderConfig(
    ...
    companion object CREATOR : Parcelable.Creator<VideoEncoderConfig> {
        override fun createFromParcel(parcel: Parcel): VideoEncoderConfig {
            return VideoEncoderConfig(parcel)
        }

        override fun newArray(size: Int): Array<VideoEncoderConfig?> {
            return arrayOfNulls(size)
        }
    }
}
