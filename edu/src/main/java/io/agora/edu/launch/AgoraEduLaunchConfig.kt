...
class AgoraEduLaunchConfig(val userName: String,
                           ...
                           var videoEncoderConfig: VideoEncoderConfig? = null,
    ...
    private constructor(userName: String,
            ...
            rtmToken, startTime, duration, boardRegion, videoEncoderConfig, userProperties, widgetConfigs) {
    ...
    constructor(parcel: Parcel) : this(
            ...
            parcel.readInt(),
            parcel.readString() ?: "",
            parcel.readParcelable(VideoEncoderConfig::class.java.classLoader)
    )
